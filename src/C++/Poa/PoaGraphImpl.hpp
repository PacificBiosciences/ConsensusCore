...
struct PoaNode
{
    size_t Id;  // This is the external-facing identifier we use to represent the
                // vertex
    char Base;
    int Reads;
...
class PoaGraphImpl
{
    ...
    BoostGraph g_;
    VertexInfoMap vertexInfoMap_;  // NB: this is a reference type and refers to an
    ...
    size_t liveVertices_;                // vertices that are in the graph.  this is needed for
                                         // algorithms.
